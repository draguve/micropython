...
extern const qconf_t qconf;       /* @warning GLOBAL Q configuration options */
...
d_t divn(const d_t v, const unsigned p);
...
void check_nlz(q_t a);
void check_nlez(q_t a);
void check_nlo(q_t a);
